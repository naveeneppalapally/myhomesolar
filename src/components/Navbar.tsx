          ...
          <div className="flex items-center justify-between px-5 sm:px-8 h-16">
            ...
            >
              ...
              <span className="font-heading font-bold text-[15px] text-solar-text">
                MyHome <span style={{ color: 'var(--solar-gold)' }}>Solar</span>
              </span>
            </button>
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <button
                ...
                className="w-9 h-9 rounded-lg border flex items-center justify-center cursor-pointer transition-colors hover:border-[var(--solar-gold)] hover:text-[var(--solar-gold)]"
                style={{ borderColor: 'var(--solar-border)', color: 'var(--solar-text-muted)', background: 'transparent' }}
              >
                {theme === 'dark' ? <Sun className="w-4 h-4" /> : <Moon className="w-4 h-4" />}
              </button>
              ...
              <a
                href="tel:+919493936249"
                className="flex items-center gap-2 font-body text-sm font-medium px-4 py-2 rounded-lg border transition-colors hover:border-[var(--solar-gold)] hover:text-[var(--solar-gold)]"
